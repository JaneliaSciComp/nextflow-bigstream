    ...
    def res = BIGSTREAM_REGISTRATION(
                Channel.of(
                    [
                        ...
                        final_params.global_fixed_mask_path,
                        final_params.global_fixed_mask_subpath,
                        final_params.global_moving_mask_path,
                        final_params.global_moving_mask_subpath,
                        ...
                        final_params.local_fixed_mask_path,
                        final_params.local_fixed_mask_subpath,
                        final_params.local_moving_mask_path,
                        final_params.local_moving_mask_subpath,
                        final_params.local_steps,
                        final_params.local_output_path,
                        final_params.local_transform_name,
                        final_params.local_transform_subpath,
                        final_params.local_inv_transform_name,
                        final_params.local_inv_transform_subpath,
